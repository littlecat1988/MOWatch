...
public class BaoBeiInfoActivity extends CommonBaseActivity implements
...
//			break;
    ...
    boolean checkInfo() {
        if (baby_name_text.getText().toString().trim().equals("")) {
            ...
            return false;
        } else if (baby_height_text.getText().toString().trim().equals("") || baby_height_text.getText().toString().trim().equals("0")) {
            showToast(R.string.baobei_error3);
            return false;
        } else if (baby_width_text.getText().toString().trim().equals("") || baby_width_text.getText().toString().trim().equals("0")) {
    ...
    private void SetBabyDataToBack(String head, String name, String sex,
        ...
        map.put("device_name", Constants.transUTF(name));
        ...
        String uRl = Constants.BABYSETTING;
        ...
        switch (resultCode) {
            case 1: // 成功
                ...
                if (bundle != null) {
                    ...
                    if (toMain) {
                        Intent i = new Intent();
                        i.setClass(BaoBeiInfoActivity.this, LocationActivity.class);
                        startActivity(i);
                    }
                }
                finish();
...
//		onHeadUrlUpload();   //ͷ���ϴ��ӿ���ʱ��д
    ...
    private void onSuccess(Uri uri) {
        // TODO Auto-generated method stub
        baby_photo.setImageURI(uri);
    }

    private void onDeleteCache() {
        if (CropHelper.clearCachedCropFile(mCropParams.uri)) {
            mCropParams = new CropParams("2" + "_" + Constants.getCurrentTimeLong() + ".jpg");
        }
    }
