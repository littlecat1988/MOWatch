...
public class KCalendar extends ViewFlipper implements
	...
	public static final int COLOR_BG_WEEK_TITLE = Color.parseColor("#fff6f5ec"); // 星期标题背景颜色
	public static final int COLOR_TX_WEEK_TITLE = Color.parseColor("#ff444444"); // 星期标题文字颜色
	public static final int COLOR_TX_THIS_MONTH_DAY = Color
			.parseColor("#aa564b4b"); // 当前月日历数字颜�?
	public static final int COLOR_TX_OTHER_MONTH_DAY = Color
			.parseColor("#ffcccccc"); // 其他月日历数字颜�?
	public static final int COLOR_TX_THIS_DAY = Color.parseColor("#ff008000"); // 当天日历数字颜色
	public static final int COLOR_BG_THIS_DAY = Color.parseColor("#fff6f5ec"); // 当天日历背景颜色
	public static final int COLOR_BG_CALENDAR = Color.parseColor("#fff6f5ec"); // 日历背景�?
