...
import care.scan.bitmap.PlanarYUVLuminanceSource;

/**
 * 浣滐拷?: 闄堟稕(1076559197@qq.com)
 * 
 * 鏃堕棿: 2014锟�锟�锟�涓嬪崍12:24:13
 * 
 * 鐗堟湰: V_1.0.0
 * 
 * 鎻忚堪: 鎺ュ彈娑堟伅鍚庤В锟� */
final class DecodeHandler extends Handler {
	...
	private void decode(byte[] data, int width, int height) {
		...
		String result = manager.decode(rotatedData, width, height, false, activity.getX(), activity.getY(), activity.getCropWidth(),
